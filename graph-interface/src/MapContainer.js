...
import houseClosestObj from './houseClosestObj.json'
...
import { clickedHouseIdState, closestObjState, pathClosestObject, splitNodes, popupHouseState } from './store';
            ...
            >
                ...
                {popupHouse && (
                    <Popup
                        key={popupHouse}
                        position={[
                            selectedNodes[popupHouse].y,
                            selectedNodes[popupHouse].x
                        ]}
                        onClose={() => { setPopUpHouse(null) }}
                    >
                        <CardComp />
                    </Popup>
                )}
